    ...
    <body>
        <div id="login_container">
            ...
            <div id="right_container">
                <form  id="form_admin" name="form_admin" method="post" action="./check_admin_login.php"  onsubmit="return checkUser()">
                	<div id="user_info">
                        <div id="username_info">
                        	<label>Username:</label>
                            <img src="../images/user.png" /><input id="admin_username" type="text" name="user" maxlength="32" placeholder="Username" />
                        </div>
                        <div id="password_info">
                        	<label>Password:</label>
                            <img src="../images/pwd.png" /><input id="admin_password" type="password" name="pwd" maxlength="32" placeholder="Password" />
                        </div>
                        <div id="clear"></div>
                    </div>
                    <div id="loginButton">
