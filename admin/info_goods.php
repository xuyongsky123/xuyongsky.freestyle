            ...
            <div id="action_content" class="action_content">
                ...
                <div id="add_item" class="group_content">
                    <form id="search_form" action="./info_goods_show.php" method="post">
                        ...
                        <input name="shop_identify" type="hidden" value="goods_add_item" />
                        ...
                        <div class="search_container">
                            <input name="goods_name" type="text" placeholder="商品名称"/>
                        </div>
                        <div class="search_container">
                            <input name="goods_price" type="text" placeholder="商品价格"/>
                        </div>
                        <div class="search_container">
                            <input name="goods_detail" type="text" placeholder="商品详情"/>
                        </div>
                        <div class="search_container">
                        ...
                        <?php  
                            ...
                            if($array){
                                foreach($array as $item){
                                    echo "<div>";
                                    echo "<span><input name='goods[]' type='checkbox' value='".$item['shop_id']."'>".$item['shop_name']."</span>";
