...
require("./database/connDB.inc.php");
	header("Content-Type:text/html;charset=utf-8");
            ...
            $sql="insert into shop_single_detail(shop_name,shop_keeper,goods_name,goods_price,goods_detail,goods_image,goods_style_top,goods_style_bottom)values('品牌手机小店','闭上眼会有好梦吗','iPad','待商定价','iPad','$article','palette-sun-flower','palette-orange');";
